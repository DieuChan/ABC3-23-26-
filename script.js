document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        { name: 'Hoàng Việt', nickname: '', quote: 'Thanh xuân như một tách trà...', img: 'viet.jpg', hobbies: 'Chụp ảnh, du lịch', message: 'Thành công trên con đường mình chọn nha!' },
        { name: 'Thành Trí', nickname: '', quote: 'Học không chơi đánh rơi tuổi trẻ.', img: 'tri.jpg', hobbies: 'Cafe, nghe nhạc', message: 'Hẹn gặp lại ở đại học.' },
        { name: 'Phương Phương', nickname: '', quote: 'Sống trọn từng phút giây.', img: 'phuong.jpg', hobbies: 'Vẽ tranh, Nghe nhạc', message: 'Chúc cả lớp thành công!' },
        { name: 'Tường Uyên', nickname: '', quote: 'Luôn là chính mình.', img: 'uyen.jpg', hobbies: 'Nấu ăn, Chơi game', message: 'Thương lớp mình lắm.' },
        { name: 'Trần Kiệt', nickname: 'Việt "Bé"', quote: 'Ngày mai sẽ tốt hơn.', img: 'kiet.jpg', hobbies: 'Cầu lông, Xem phim', message: 'Đừng quên mình nhé.' },
        { name: 'Thảo Vy', nickname: '', quote: 'Cứ đi rồi sẽ đến.', img: 'vy.jpg', hobbies: 'Đọc sách, Ca hát', message: 'Chào thân ái!' },
    ];
